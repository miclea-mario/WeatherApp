...
import { Input, Card, CardBody, Button, Divider, Chip } from "@nextui-org/react";
...
export default function Weather(props) {
  ...
  return (
    <div className="flex flex-col items-center">
                ...
                <TextInfoCard
                  ...
                  value={
                    props.weatherData.currentConditions.precip
                      ? `${props.weatherData.currentConditions.precip.toFixed(
                          1
                        )}`
                      : `0`
                  }
      ...
      <Chip  className="mt-8 w-fit bg-white/80 backdrop-blur-sm" size="sm">made by Mario Miclea</Chip>
    </div>
  );
}
